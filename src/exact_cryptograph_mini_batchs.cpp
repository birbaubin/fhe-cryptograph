////
//// Created by Aubin Birba on 2023-10-01.
////
//
//
//#include <iostream>
...
//
//
//void RunCryptograph(std::vector<std::vector<int64_t>> graph1,
...
//    usint ringDim = 1 << 13; // 2^15 = 32768
////    usint numberOfNodes = ringDim / graph1.size();
////    usint numberOfNodes = 1;
//
//    int numberOfBatches = ringDim / batchSize;
//
...
//    }
//
//    std::cout << "Size of plaintext " << plaintextResult->GetPackedValue().size() << std::endl;
//
//    gettimeofday(&t_end, NULL);
//
//    total_time += getMillies(t_start, t_end);
//    std::cout << "Average time over " << numberOfBatches << " predictions : " << total_time / numberOfBatches << " ms" << std::endl;
//
//}
//
//
